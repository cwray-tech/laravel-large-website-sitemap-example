<x-guest-layout>
    <div class="relative bg-gray-50 overflow-hidden">
        ...
        <div class="relative min-h-screen pt-6 pb-12 sm:pb-16 md:pb-20 lg:pb-28 xl:pb-32">
            ...
            <main class="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 xl:mt-28">
                <div class="text-center">
                    <h1 class="text-4xl tracking-tight leading-10 font-extrabold text-gray-900 sm:text-5xl sm:leading-none md:text-6xl">
                        A Sitemap Example with
                        <br class="xl:hidden">
                        <span class="text-indigo-600">Laravel 8</span>
                    </h1>
                    <p class="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                        This is a simple Laravel 8 application showing how to build a custom xml sitemap for a website
